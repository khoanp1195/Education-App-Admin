...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.EventListener.FingerprintHandler, Project1", FingerprintHandler.class, __md_methods);
	}
	...
	public FingerprintHandler ()
	{
		...
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("Project1.EventListener.FingerprintHandler, Project1", "", this, new java.lang.Object[] {  });
	}
	...
	public FingerprintHandler (android.content.Context p0)
	{
		super ();
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("Project1.EventListener.FingerprintHandler, Project1", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
