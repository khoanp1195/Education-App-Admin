...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.MainActivity+FabAnimatorListener, Project1", MainActivity_FabAnimatorListener.class, __md_methods);
	}
	...
	public MainActivity_FabAnimatorListener ()
	{
		...
		if (getClass () == MainActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Project1.MainActivity+FabAnimatorListener, Project1", "", this, new java.lang.Object[] {  });
	}
	...
	public MainActivity_FabAnimatorListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == MainActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Project1.MainActivity+FabAnimatorListener, Project1", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
