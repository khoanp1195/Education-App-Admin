...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.EventListeners.UserProfileListeners, Project1", UserProfileListeners.class, __md_methods);
	}


	public UserProfileListeners ()
	{
		super ();
		if (getClass () == UserProfileListeners.class)
			mono.android.TypeManager.Activate ("Project1.EventListeners.UserProfileListeners, Project1", "", this, new java.lang.Object[] {  });
	}
