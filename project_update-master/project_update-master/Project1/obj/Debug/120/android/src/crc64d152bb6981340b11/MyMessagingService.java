...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.Activities.FirebaseMessage.MyMessagingService, Project1", MyMessagingService.class, __md_methods);
	}
	...
	public MyMessagingService ()
	{
		...
		if (getClass () == MyMessagingService.class)
			mono.android.TypeManager.Activate ("Project1.Activities.FirebaseMessage.MyMessagingService, Project1", "", this, new java.lang.Object[] {  });
	}
