...
{
    public class EditAluminiFragment : Android.Support.V4.App.DialogFragment, TextToSpeech.IOnInitListener
    {
        ...
        private void SavechangesButton_Click(object sender, EventArgs e)
        {
            ...
            saveDataAlert.SetPositiveButton("Continue", (senderAlert, args) =>
            {
                ...
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/NewWord").SetValue(newWord);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/Mean").SetValue(mean);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/Spelling").SetValue(spelling);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/Type").SetValue(type);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/Level").SetValue(level);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/Example").SetValue(examplee);
                AppDataHelper.GetDatabase().GetReference("Normal/" + thisAlunini.ID + "/MeanEnglish").SetValue(meanenglish);
