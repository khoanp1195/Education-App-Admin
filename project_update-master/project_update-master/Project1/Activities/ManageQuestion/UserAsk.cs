...
{
    [Activity(Label = "UserAsk")]
    public class UserAsk : AppCompatActivity
    {
        ...
        public void Control()
        {
            ...
            search = (EditText)FindViewById(Resource.Id.edtSearch);
            ...
            linearLayout = (NestedScrollView)FindViewById(Resource.Id.linearLayout1);
